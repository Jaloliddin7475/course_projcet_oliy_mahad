...
import uz.oliymahad.userservice.dto.response.QueueUserDetailsDTO;
import uz.oliymahad.userservice.dto.response.QueueUserPageableResponse;
...
//        List<UserDataResponse> users = userFeign.getUsers(new UsersIDSRequest(userIds));
       List<UserDataResponse> users = null;
